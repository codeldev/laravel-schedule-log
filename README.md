...
```bash
php artisan vendor:publish --tag="laravel-schedule-log-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-schedule-log-config"
```
...
Then in `config/laravel-schedule-log.php`:
