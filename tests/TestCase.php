...
class TestCase extends Orchestra
{
    ...
    public function getEnvironmentSetUp($app): void
    {
        ...
        $app['config']->set('laravel-schedule-log', require __DIR__ . '/../config/laravel-schedule-log.php');
    }
    ...
    {
        self::$migration = include __DIR__ . '/../database/migrations/create_laravel_schedule_log_table.php.stub';
    }
}
