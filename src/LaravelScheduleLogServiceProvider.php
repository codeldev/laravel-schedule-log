...
final class LaravelScheduleLogServiceProvider extends PackageServiceProvider
{
    public function configurePackage(Package $package): void
    {
        $package
            ...
            ->hasConfigFile()
            ->hasMigration('create_laravel_schedule_log_table')
    ...
    private function bindModels(): void
    {
        ...
        $commandModel = config('laravel-schedule-log.models.commands', LaravelScheduledCommand::class);

        /** @var class-string $historyModel */
        $historyModel = config('laravel-schedule-log.models.history', LaravelScheduledCommandHistory::class);
